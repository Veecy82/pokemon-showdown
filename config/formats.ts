...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 7] Wob Cup",
		desc: `A combination of Doubles, Pure Hackmons, and Mix and Mega, all set in Generation 7 (USUM).`,
		threads: [
			`&bullet; <a href="https://discord.gg/9wq3xa8D5F/">Join at your own risk</a>`,
		],
